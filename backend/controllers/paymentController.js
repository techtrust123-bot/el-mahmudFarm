  ...
  try {
    ...
    const rows = payments.map((payment) => {
      ...
      return {
        ...
        status,
        paymentReference: payment.reference,
        startDate: users.subscriptionStart || payer.subscriptionStart || payment.subscriptionStart,
        endDate: users.subscriptionEnd || payer.subscriptionEnd || payment.createdAt,
